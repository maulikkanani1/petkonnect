                ...
                <div class="container-fluid">
                  <div className="m-3">
                    <div className="image-wrapper rounded-circle">
                      <img
                        src={image !== undefined && image.length !== 0 ? window.URL.createObjectURL(image[0]) : isUpdate ? pet.petImage : './../../img/profile_img_2.png'}
                        className="pet-image rounded-circle"
                      />
                    </div>
                    <div >
                      <input className="image-input" id="img" name="image" type="file" placeholder="Change Pet Image" {...register('image')} />
                      <label className="image-input-label" htmlFor="img">{isUpdate ? 'Change Pet Image' : 'Upload Pet Image'}</label>
                    </div>
                  </div>
